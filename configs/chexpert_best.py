...
class Config(BaseConfig):
    def __init__(self):
        ...
        self.scheduler_args = dict(T_max=200, eta_min=self.lr*0.1)
        ...
        self.train_dataset = CheXpert(self.data_root+'/train_256_'+self.data_type, train=True,
        ...
        self.val_dataset = CheXpert(self.data_root+'/val_256_'+self.data_type, train=False,
        ...
        self.test_dataset = CheXpert(self.data_root+'/our_test_256_'+self.data_type, train=False,
                            img_size=(self.img_size, self.img_size), full=True,  data_type=self.data_type)
